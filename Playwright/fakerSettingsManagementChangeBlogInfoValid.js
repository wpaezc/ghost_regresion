...
const titleTest = "settingsManagementChangeBlogInfoFaker"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`

const url = `${ghostUrl}/ghost/#/signin`;
console.log('Run tests for SETTINGS MANAGEMENT CHANGE BLOG INFO');
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:above(:text('The name of your site'))", faker.lorem.sentence());
        await page.fill("input:above(:text('Used in your theme, meta data and search results'))", faker.lorem.paragraph());
