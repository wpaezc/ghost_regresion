...
const titleTest = "settingsManagementChangeMetadataLimit"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`
const dataPool = require("./poolSources/settingsManagementChangeMetadataLimitPool");


const url = `${ghostUrl}/ghost/#/signin`;
console.log('Run tests for SETTINGS MANAGEMENT CHANGE METADATA');
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:below(:text('Meta title'))", String(obj.titulo));
