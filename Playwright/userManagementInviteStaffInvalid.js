...
const titleTest = "userManagementInviteStaffInvalidd"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`
const dataPool = require("./poolSources/userManagementInviteStaffInvalidPool");


const url = `${ghostUrl}/ghost/#/signin`;

console.log('Run tests for USER MANAGEMENT INVITE STAFF - INVALID DATA');
