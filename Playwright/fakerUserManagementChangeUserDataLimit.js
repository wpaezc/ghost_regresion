...
const titleTest = "fakerUserManagementChangeUserDataLimit"
...
(async () => {
    ...
    for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
        ...
        for (let i = 0; i < 2; i++) {
                ...
                console.log(`Scenario ${i}: Change user data`)
                ...
                await page.fill('id=user-slug', faker.lorem.slug(5));
                ...
                await page.fill('id=user-bio', faker.lorem.paragraph(15));                
