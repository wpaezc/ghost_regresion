...
const titleTest = "fakerSettingsManagementChangeMetadataInvalid"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`

const url = `${ghostUrl}/ghost/#/signin`;
console.log('Run tests for SETTINGS MANAGEMENT CHANGE METADATA INVALID');
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:below(:text('Meta title'))", faker.lorem.sentence(20));
