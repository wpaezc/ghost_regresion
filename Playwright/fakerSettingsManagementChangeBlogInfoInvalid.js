...
console.log('Run tests for SETTINGS MANAGEMENT CHANGE INVALID BLOG INFO');
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:above(:text('The name of your site'))", faker.lorem.paragraph(3) );
        await page.fill("input:above(:text('Used in your theme, meta data and search results'))", faker.lorem.paragraph(6));
