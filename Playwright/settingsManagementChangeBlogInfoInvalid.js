...
const titleTest = "settingsManagementChangeBlogInfoRandom"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`
const dataPool = require("./poolSources/settingsManagementChangePublicationInfoInvalidPool");
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:above(:text('The name of your site'))", obj.titulo);
        await page.fill("input:above(:text('Used in your theme, meta data and search results'))", obj.description);
