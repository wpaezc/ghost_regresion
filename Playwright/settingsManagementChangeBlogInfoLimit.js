...
const titleTest = "settingsManagementChangeBlogInfoLimit"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`
const dataPool = require("./poolSources/settingsManagementChangePublicationInfoLimitPool");
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:above(:text('The name of your site'))", String(obj.titulo));
        await page.fill("input:above(:text('Used in your theme, meta data and search results'))", String(obj.description));
