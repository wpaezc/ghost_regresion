...
const titleTest = "settingsManagementChangeMetadataInvalid"
const pathScreenshotsTest =`./${nameScreenPath}/${titleTest}/`
const dataPool = require("./poolSources/settingsManagementChangeMetadataInvalidPool");
...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    //Contenido de la prueba
        ...
        await page.fill("input:below(:text('Meta title'))", obj.titulo);
